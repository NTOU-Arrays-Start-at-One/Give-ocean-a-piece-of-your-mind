...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.PB_cal = QtWidgets.QPushButton(self.centralwidget)
        self.PB_cal.setGeometry(QtCore.QRect(bias_width + 50, 700, 71, 23))
        ...
        self.PB_ok_2.setGeometry(QtCore.QRect(bias_width + 530, 750, 90, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.PB_ok_2.setText(_translate("MainWindow", "Return Points"))
        self.label_E.setText(_translate("MainWindow", "mean E: "))
        self.PB_cal.setText(_translate("MainWindow", "Calculate"))
